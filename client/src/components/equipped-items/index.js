...
const EquippedItems = ({ stats, unequipItem }) => {
  ...
  const { weapon, armor } = stats.equippedItems;
  ...
  return (
    <div className='equipped-items__character'
      ...
      <div className='flex-row space-between'>
        ...
        <EmptySlot className='white-border equipped-items__gloves--left'>
          {
            weapon ?
              <button className='equipped-items__slot'
          ...
          {/* changed  equipped-items__weapon with equipped-items__gloves--left just for placement */}
